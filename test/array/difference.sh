...
_.difference arr_diff1 arr1 arr2 && pass || fail "function error"
[ "${#arr_diff1[*]}" == "${#expected1[*]}" ] && pass || fail
[ "${arr_diff1[0]}" == "${expected1[0]}" ] && pass || fail
[ "${arr_diff1[1]}" == "${expected1[1]}" ] && pass || fail

_.difference arr_diff2 arr2 arr1 && pass || fail "function error"
...
_.difference result1 arr1 arr2
...
_.difference result2 arr2 arr1
