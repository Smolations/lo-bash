...
_difference arr_diff1 arr1 arr2 && pass || fail "function error"
[[ "${#arr_diff1[*]}" == "${#expected1[*]}" ]] && pass || fail
[[ "${arr_diff1[0]}" == "${expected1[0]}" ]] && pass || fail
[[ "${arr_diff1[1]}" == "${expected1[1]}" ]] && pass || fail

_difference arr_diff2 arr2 arr1 && pass || fail "function error"
