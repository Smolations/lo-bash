## /* @function
 #  @usage _::number::in_range <number> <start=0> <end>
 #
 #  @output true
 #
 #  @description
 ...
 #
 #  @examples
 #  $ _::number::in_range 5 10    # true
 #  $ _::number::in_range 5 4 10  # true
 #  $ _::number::in_range 15 10   # false
 #  examples@
 #
 #  @dependencies
 #  dependencies@
